...
(defun create-penmacs-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (orglink       (if (eq variant 'dark) (if (true-color-p) "#2aa1ae" "#008787") (if (true-color-p) "#2aa1ae" "b#008787")))
        (comment       (if (eq variant 'dark) (if (true-color-p) "#818181" "#787878") (if (true-color-p) "#818181" "#787878")))
...
;;;;; org
     ...
     `(org-link ((,class (:underline t :foreground ,orglink))))
